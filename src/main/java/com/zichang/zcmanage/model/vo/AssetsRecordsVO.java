...
public class AssetsRecordsVO {
     ...
     * @return
     */
    public static AssetsRecords voToObj(AssetsRecordsVO assetsRecordsVO) {
     ...
     * @return
     */
    public static AssetsRecordsVO objToVo(AssetsRecords assetsRecords) {
